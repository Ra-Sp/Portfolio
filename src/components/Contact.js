            ...
            <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                onSubmit={handleSubmit}>
                    ...
                    <div className="relative mb-4">
                        ...
                        id="name"
                        name="name"
                        className="w-full bg-customViolet3 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                        required
                        />
                    </div>
                    <div className="relative mb-4">
                    ...
                    <div className="relative mb-4">
                        ...
                        id="message"
                        name="message"
                        className="w-full bg-customViolet3 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 h-32 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                        />
                    </div>
                    <button
                        type="submit"
